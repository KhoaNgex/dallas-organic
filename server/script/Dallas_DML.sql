INSERT INTO `blogs` (`title`, `subtitle`, `min_read`, `content`, `image`) VALUES
('5 Healthy Lifestyle Tips to Improve Your Overall Health', 
'Reduce your tiredness and boost your health with these simple changes', 
2, 
'<div style="display: flex; justify-content: center;">
                        <img src="https://imgeng.jagran.com/images/2023/mar/healthy-lifestyle-changes-for-weight-loss1677901066822.jpg"
                            alt="Healthy food" class="img-fluid" style="max-width: 50%;">
                    </div>
                    <p>Living a healthy lifestyle is important for maintaining a strong body and mind. Here are 5 tips
                    ...
                    <p>By following these healthy lifestyle tips, you can improve your overall health and well-being.
                        Remember, small
                        changes can make a big difference!</p>', 'https://imgeng.jagran.com/images/2023/mar/healthy-lifestyle-changes-for-weight-loss1677901066822.jpg');

INSERT INTO `blogs` (`title`, `subtitle`, `min_read`, `content`, `image`) VALUES
('Thực Phẩm Hữu Cơ - Sự Lựa Chọn Sức Khỏe', 
'Tại Sao Bạn Nên Cân Nhắc Ăn Thực Phẩm Hữu Cơ', 
2, 
'<p>Thực phẩm hữu cơ đã trở nên ngày càng phổ biến trong những năm gần đây, khi mọi người đang ngày càng nhận
        ...
        <p>Vì vậy, nếu bạn quan tâm đến sức khỏe của mình và muốn ăn những thực phẩm tốt cho sức khỏe và môi trường, hãy
            ...
            nông sản
            địa phương, và hãy ủng hộ các nông dân và nhà sản xuất hữu cơ địa phương của bạn.</p>', 'https://i.ndtvimg.com/i/2015-05/organic_625x350_41430972446.jpg');
            
INSERT INTO `blogs` (`title`, `subtitle`, `min_read`, `content`, `image`) VALUES
('Lợi ích tuyệt vời của cà chua', 
'Tại sao bạn nên ăn cà chua mỗi ngày?', 
5, 
'<p>Cà chua được mệnh danh là một nhà máy dinh dưỡng vì nó cung cấp rất nhiều thành phần có lợi cho
            sức khỏe,
        ...
        <div style="display: flex; justify-content: center;">
            <img src="https://cafefcdn.com/203337114487263232/2021/10/19/-16346173216542069545051.jpg" alt="Healthy food" class="img-fluid"
                style="max-width: 50%;">
        </div>
